<template>
	<div class="cancel-order-modal">
		<scroll-view class="popheight" scroll-y="true">
			<div class="cancel-order-condition" v-for="(list,index) in confirmPlan.carries" :key="index">
				...
				<div class="cancel-statement-wrap">
					<div class="cancel-radio-wrap">
						<span class="cancel-radio"></span>
						<span class="cancel-label">楼层: {{confirmPlan.floor}}</span>
					</div>
				</div>
				<div class="cancel-statement-wrap">
					<div class="cancel-radio-wrap">
			...
			<div class="cancel-order-condition">
				...
				<div class="cancel-statement-wrap">
					...
					<div class="cancel-radio-wrap" v-if="confirmPlan.carryDiscount != 10">
						<span class="cancel-radio"></span>
					...
					<div class="cancel-radio-wrap">
						<span class="cancel-radio"></span>
						<span class="cancel-label">合计 ¥{{confirmPlan.all}}</span>
					</div>
					<div class="cancel-radio-wrap">
						<span class="cancel-radio"></span>
						<span class="cancel-label">预付搬运费 ¥-{{confirmPlan.carryStartPrice}}</span>
					</div>
				</div>
			</div>
		</scroll-view>
		<div class="agree-plan-wrap">
			<button class="cancel-plan agree-plan" @click="againPlan">重新申报</button>
			<button class="cancel-plan agree-plan" @click="confirmPlanClick">同意报价</button>
		</div>
	</div>
</template>
